    ...
    const [_jimp, sharp] = await Promise.all([
        (async () => {
            try {
                ...
                console.log('Jimp no está disponible');
                return null;
            }
        })(),
        (async () => {
            try {
                ...
                console.log('Sharp no está disponible');
                return null;
            }
        })()
    ]);
...
async function uploadFile(buffer, logger) {
    try {
        ...
        console.log('Error en uploadFile:', e.message);
        throw e;
    }
}
...
const extractVideoThumb = async (videoPath) => {
    try {
        ...
        console.log('Error en extractVideoThumb:', e.message);
        throw e;
    }
};
...
const extractImageThumb = async (bufferOrFilePath, width = 32) => {
    ...
    try {
        ...
        console.log('Error en extractImageThumb:', e.message);
        throw e;
    }
};
...
const generateProfilePicture = async (mediaUpload) => {
    try {
        ...
        console.log('Error en generateProfilePicture:', e.message);
        throw e;
    }
};
...
async function getAudioDuration(buffer) {
    try {
        ...
        console.log('Error en getAudioDuration:', e.message);
        throw e;
    }
}
/**
